...
public class Controller {
    ...
    public void doCreateTodoItem() {
        ...
        Person findPerson = personDao.findById(personData.getId());

        todoItemData.setAssignee(findPerson);
        TodoItem createTodoItem = todoItemDao.create(todoItemData);

        ui.displayTodoItemInformation(createTodoItem);
